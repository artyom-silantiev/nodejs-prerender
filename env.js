...
export default {
  ...
  PRERENDER_WAIT_AFTER_LAST_REQUEST: toInt(
    env.PRERENDER_WAIT_AFTER_LAST_REQUEST,
    1800
  ),

  PRERENDER_CACHE_MEM_MAX_ITEMS: toInt(env.PRERENDER_CACHE_MEM_MAX_ITEMS, 1000),
  PRERENDER_CACHE_MEM_TTL_SEC: toInt(
    env.PRERENDER_CACHE_MEM_TTL_SEC,
    60 * 60 * 24
  ), // seconds

  PRERENDER_CACHE_FILE_MAX_ITEMS: toInt(
    env.PRERENDER_CACHE_FILE_MAX_ITEMS,
    5000
  ),
  PRERENDER_CACHE_FILE_MAX_SIZE: toInt(
    env.PRERENDER_CACHE_FILE_MAX_SIZE,
    1024 * 1024 * 1024
  ), // 1024 mb
  PRERENDER_CACHE_FILE_LOCATION: toString(
    env.PRERENDER_CACHE_FILE_LOCATION,
    "temp/prerender_cache"
  ),
};
